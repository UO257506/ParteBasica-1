...
;.....
    ...
    .equ pruebaaNumTaps, 61

;.....
; Allocate and initialize filter taps

		.section .pruebaaconst, "x"
		.align 128
pruebaaTaps:
...
pruebaaDelay:
		.space pruebaaNumTaps*2

; .....
; Allocate and intialize filter structure

		.section .data
		.global _pruebaaFilter

_pruebaaFilter:
.hword pruebaaNumTaps
.hword psvoffset(pruebaaTaps)
.hword psvoffset(pruebaaTaps)+pruebaaNumTaps*2-1
.hword psvpage(pruebaaTaps)
.hword pruebaaDelay
.hword pruebaaDelay+pruebaaNumTaps*2-1
.hword pruebaaDelay
